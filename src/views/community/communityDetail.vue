	...
	<div class="community-detail" v-if="isDelete">
		...
		<el-card>
		  ...
		  <div class="el-card-info">
			...
			<div class="bottom">
			  <p v-html="data.communityDetail.content"></p>
			</div>
		...
		<div class="line-list" v-for="item in data.commentsData">
			<div class="line-list-icon">
				...
				<span v-if="item.nickName === store.state.userInfoX.nickName || store.state.userInfoX.user_type > 1" class="hoverActive" @click="deleteClick(item.id)">删除</span>
			</div>
